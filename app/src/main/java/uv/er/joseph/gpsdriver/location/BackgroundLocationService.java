...
public class BackgroundLocationService extends Service implements
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //onLocationChanged(Location location) myThread = new onLocationChanged();
        //myThread.start();
    ...
    public void onLocationChanged(Location location) {
        ...
        //appendLog(latitude + "," + longitude + "," + count, Constants.LOCATION_FILE);
        //appendLog(latitude + "," + longitude + "," + count, Constants.LOCATION_FILE);

        /* Receiver s*/
        Intent coordinates = new Intent();
        coordinates.setAction(MY_ACTION);
        coordinates.putExtra("DATAPASSED", latitude);
        coordinates.putExtra("DATAPASSED2", longitude);
        sendBroadcast(coordinates);
        /* Receiver e*/
    }
